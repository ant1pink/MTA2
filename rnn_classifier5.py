...
i14 = LSTM(64, return_sequences = True, dropout = 0.2, recurrent_dropout = 0.2)(i13)
#i15 = Dropout(0.2)(i14)
i15 = LSTM(64, dropout = 0.2, recurrent_dropout = 0.2)(i14)
#i17 = Dropout(0.2)(i16)
...
multimodal = LSTM(64)(multimodal)
multimodal = Dropout(0.2)(multimodal)
#multimodal = Flatten()(multimodal)
multimodal = concatenate([i15, multimodal, i23])
...
x22 = [[0, 5000], [10000,20000],[20000,30000],[maxvalue_of_time,maxvalue_of_time]]
x22 = newrange(x22)
x11 = sequence.pad_sequences([[2536, 1163],[2536, 1163], [2536, 1163],[2536, 1163]], padding = padding_method, maxlen=max_tps_length)
x22 = sequence.pad_sequences(x22, maxlen=max_tps_length, dtype='float', padding = padding_method, value = padding_value)
yp = model.predict([x11,x22])
yp
