...
i22 = TimeDistributed(Dense(int(i13.shape[2])))(i21)
#i22 = Reshape((max_tps_length,1))(i21)
#l1 = dot([i12, i22], axes = -1)
#l1 = concatenate([i12, i22], axis=-1)

i31 = Input(shape = (max_tps_length,))
i32 = Reshape((max_tps_length,1))(i31)
i32 = TimeDistributed(Dense(int(i13.shape[2])))(i31)

#l1 = multiply([i13, i22, i32])
#l1 = dot([l1, i22, i32], axes = -1)
l1 = concatenate([i13, i22, i32], axis=-1)
l1 = LSTM(128, return_sequences = True, dropout = 0.2, recurrent_dropout = 0.2)(l1)
#l1 = dot([l1, i22, i32], axes = -1)
#l1 = concatenate([l1, i22, i32], axis=-1)
#l1 = multiply([i13, i22, i32])
l1 = LSTM(128, return_sequences = True, dropout = 0.2, recurrent_dropout = 0.2)(l1)
#l1 = dot([l1, i22, i32], axes = -1)
#l1 = concatenate([l1, i22, i32], axis=-1)
#l1 = multiply([i13, i22, i32])
l1 = LSTM(128, dropout = 0.2, recurrent_dropout = 0.2)(l1)
...
#x11 = sequence.pad_sequences([[120],[120], [120],[120]], padding = padding_method, maxlen=max_tps_length)
x22 = sequence.pad_sequences(x22, maxlen=max_tps_length, dtype='float', padding = padding_method, value = padding_value)
...
x11 = sequence.pad_sequences([[2629],[2629], [2629],[2629]], padding = padding_method, maxlen=max_tps_length)
...
x22 = newrange(x22)
x11 = sequence.pad_sequences([[22, 2802],[22, 2802], [22, 2802],[22, 2802]], padding = padding_method, maxlen=max_tps_length)
