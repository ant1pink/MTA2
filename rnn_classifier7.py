...
sum1= 0
for i, item in enumerate(X1_v):
    for j, item2 in enumerate(item):
        if y_v[i] == 0:
            sum1 +=1
print("negative sample:", sum1)
...
#i22 = TimeDistributed(Dense(16))(i22)
#i22 = Reshape((max_tps_length,1))(i21)
...
x22 = newrange(x22)
x11 = sequence.pad_sequences([[411],[411], [411],[411]], padding = padding_method, maxlen=max_tps_length)
...
x22 = newrange(x22)
x11 = sequence.pad_sequences([[411, 223],[411, 223], [411, 223],[411, 223]], padding = padding_method, maxlen=max_tps_length)
...
x22 = newrange(x22)
#x22 = [1/(np.array(i)+1) for i in x22]
x11 = sequence.pad_sequences([[223, 2536],[223, 2536], [223, 2536],[223, 2536]], padding = padding_method, maxlen=max_tps_length)
x22 = sequence.pad_sequences(x22, maxlen=max_tps_length, dtype='float', padding = padding_method,value = padding_value)
yp = model.predict([x11,x22])
yp
