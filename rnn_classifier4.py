...
i14 = LSTM(32, return_sequences = True)(i13)
i15 = Dropout(0.2)(i14)
i16 = LSTM(32)(i15)
i17 = Dropout(0.2)(i16)
...
x22 = newrange(x22)
x11 = sequence.pad_sequences([[223],[223], [223],[223]], maxlen=max_tps_length)
...
#x11 = sequence.pad_sequences([[2400],[2400], [2400],[2400]], maxlen=max_tps_length)
#x11 = sequence.pad_sequences([[2400],[2400], [2400],[2400]], maxlen=max_tps_length)
#x11 = sequence.pad_sequences([[411],[411], [411],[411]], maxlen=max_tps_length)
x11 = sequence.pad_sequences([[2536],[2536], [2536],[2536]], maxlen=max_tps_length)
x22 = sequence.pad_sequences(x22, maxlen=max_tps_length, dtype='float', value =padding_value)
yp = model.predict([x11,x22])
yp
...
x22 = newrange(x22)
x11 = sequence.pad_sequences([[411, 2536],[411, 2536], [411, 2536],[411, 2536]], maxlen=max_tps_length)
x22 = sequence.pad_sequences(x22, maxlen=max_tps_length, dtype='float', value = padding_value)
yp = model.predict([x11,x22])
yp
...
x22 = newrange(x22)
#x22 = [1/(np.array(i)+1) for i in x22]
x11 = sequence.pad_sequences([[2804, 2536],[2804, 2536], [2804, 2536],[2804, 2536]], maxlen=max_tps_length)
x22 = sequence.pad_sequences(x22, maxlen=max_tps_length, dtype='float', value = padding_value)
yp = model.predict([x11,x22])
yp
